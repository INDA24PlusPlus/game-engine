...
std::ostringstream &Logger::time_stream(std::ostringstream &stream,
                                        bool include_ms) {
...
std::ostringstream &Logger::color_stream(std::ostringstream &stream, int R,
                                         int G, int B, bool bold) {
